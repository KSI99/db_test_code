...
<body>
	<style>
		body {
			background-image: url('https://image5jvqbd.fmkorea.com/files/attach/new/20180928/486616/562458984/1292286894/1e42faf38a138e5cb0bfa174b6a4813c.jpg');
...
<?php
    ...
    $c1_d = $_POST["c1"];
    $sql = "SELECT * FROM pk WHERE Ability like '%$c1_d%'";
